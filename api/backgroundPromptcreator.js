...
dotenv.config();
  ...
  async function getGeneratedBackgroundImagePrompt(prompt) {
    const parts = [
      ...
      {text: "output: Create a background image that subtly sets the stage for a close-up shot of two friends looking at a travel brochure:  The primary focus of the image should be on the space around the two friends, not the friends themselves.  A blurred background image of a captivating travel destination. This could be a scenic mountain range, a pristine beach, or a lush forest. Subtly include details like a weathered wooden table, a window with natural light, or a cozy armchair, hinting at a relaxed and inviting environment."},
      {text: "input: A vibrant image capturing the energy and beauty of Tokyo, featuring neon\nlights, bustling streets, and the iconic Shibuya crossing.\""},
      ...
      {text: "input: A warm, inviting cafe with soft lighting, wooden tables, and pottedplants, perfect for a friendly conversation."},
